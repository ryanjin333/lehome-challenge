...
_HELPER_PATH = Path(__file__).parents[2] / "b1k_launchkit" / "token_bootstrap.py"
_SPEC = importlib.util.spec_from_file_location("trainer_token_bootstrap", _HELPER_PATH)
assert _SPEC is not None and _SPEC.loader is not None
_MODULE = importlib.util.module_from_spec(_SPEC)
_SPEC.loader.exec_module(_MODULE)
TokenBootstrapError = _MODULE.TokenBootstrapError
install_token = _MODULE.install_token
