...
def test_controlled_matrix_category_cap_rejects_extra_successes_while_legacy_is_unchanged(tmp_path) -> None:
    matrix = (
        {"episode": "episode-001", "category": "top_long", "recovery_kind": "controlled_success_recovery_snapshot_v3", "category_acceptance_cap": 1},
        {"episode": "episode-002", "category": "top_long", "recovery_kind": "controlled_success_recovery_snapshot_v3", "category_acceptance_cap": 1},
