...
from scripts.eval_groot_n17_public96 import CHECKPOINT, canonical_policy_artifact_sha256
...
def run(args: argparse.Namespace) -> int:
    ...
    PolicyServer(policy, host=args.host, port=args.port, api_token=token).run(); return 0
